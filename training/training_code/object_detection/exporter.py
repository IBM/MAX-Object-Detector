...
def write_graph_and_checkpoint(inference_graph_def,
  ...
  print("Checkpoint global step path: ", trained_checkpoint_prefix)
  global_step_value = trained_checkpoint_prefix.rsplit('/', 1)[-1].split('-')[1]
  ...
  with tf.Graph().as_default():
    ...
    with session.Session() as sess:
      ...
      saver.save(sess, model_path, global_step=int(global_step_value))
